...
| `channels.html` | **渠道库**：65 个渠道（国内 53 + 海外 12），可搜索、按分类/地区/费用筛选、排序 |
| `china.html` | 国内推广指南：搜索 / 小红书 / 抖音 / 微信生态 / 知乎 B 站 + 付费投放 + 90 天排期 |
| `overseas.html` | 海外推广：骨架已搭（12 个渠道 + 逻辑差异），实操内容建设中 |
...
| `promote.html` | 广告与内容合作：版位、报价、投放要求、合作流程（盈利入口） |
...
├── channels.html         # 渠道库
├── china.html            # 国内推广
├── overseas.html         # 海外推广（骨架）
├── cases.html            # 打法拆解
├── playbook.html         # 产品打法
├── tools.html            # 工具箱
├── glossary.html         # 术语速查
├── about.html            # 关于 / 隐私 / 广告说明
├── promote.html          # 广告与内容合作
...
海外骨架渠道只要加 `soon: true`，就可以只写 `summary` 等基础字段，详情字段会豁免检查。
